                ...
                <div class="bg-white rounded-[2rem] shadow-premium border border-slate-200/60 overflow-hidden">
                    <div class="p-8 md:p-10">
                        <div class="flex items-center gap-3 mb-8">
                            ...
                            <h3 class="text-lg font-black text-dswd-dark uppercase tracking-wider">13. Total Years of Work Experience <span class="text-red-500">*</span></h3>
                        </div>
                ...
                <div class="bg-white rounded-[2rem] shadow-premium border border-slate-200/60 overflow-hidden">
                    <div class="p-8 md:p-10">
                        <div class="flex items-center gap-3 mb-8">
                            ...
                            <h3 class="text-lg font-black text-dswd-dark uppercase tracking-wider">14. Years of Social Work–Related Experience <span class="text-red-500">*</span></h3>
                        </div>
                ...
                <div class="p-8 md:p-10">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-lg font-black text-dswd-dark uppercase tracking-wider">15. Current Tasks / Functions <span class="text-red-500">*</span></h3>
                        </div>
